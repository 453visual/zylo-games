-- =========================================================================
--  ZYLOHUB - GROW A GARDEN (v3.5 - MODULAR EDITION)
...
local State = {
    ...
    -- Pet Team Manager States (Shared with PetHatchModule)
...
-- =============================================================
-- [G] MEMBANGUN UI DENGAN ZYLOLIB (100% UTUH)
-- =============================================================
...
-- =============================================================
-- [PETS PAGE CONTENT - AUTO PLACE EGG (LOCKED)]
-- =============================================================
...
-- =============================================================
-- [MODUL EKSTERNAL 1: AUTO HATCH & PET TEAM MANAGER]
-- =============================================================
local PetHatchModule = nil
local ok, modFunc = pcall(function()
    return loadstring(game:HttpGet("https://raw.githubusercontent.com/ranklee26-glitch/zylo-games/main/PetHatchModule.lua"))()
end)

if ok and type(modFunc) == "function" then
    PetHatchModule = modFunc(PagePets, State, ZyloLib, Main)
else
    warn("[ZyloHub] Gagal memuat PetHatchModule.lua: ", modFunc)
end

-- =============================================================
-- [ACCORDION PET LAINNYA & INTEGRASI TOMBOL PET TEAM]
-- =============================================================
...
teamBtn1.MouseButton1Click:Connect(function()
    if PetHatchModule and PetHatchModule.ExecutePetTeam then
        PetHatchModule.ExecutePetTeam(State.ActiveTeam or "Main Team")
    end
end)

teamBtn2.MouseButton1Click:Connect(function()
    if PetHatchModule and PetHatchModule.GetEquippedPetsInGarden and PetHatchModule.UnequipPetByUUID then
        local inGarden = PetHatchModule.GetEquippedPetsInGarden()
        for _, gPet in ipairs(inGarden) do
            PetHatchModule.UnequipPetByUUID(gPet.UUID)
            task.wait(0.15)
        end
    end
end)
...
-- =============================================================
-- [MODUL EKSTERNAL 2: PET LEVELING MODULE (WADAH FITUR BARU)]
-- =============================================================
pcall(function()
    local levelingFunc = loadstring(game:HttpGet("https://raw.githubusercontent.com/ranklee26-glitch/zylo-games/main/PetLevelingModule.lua"))()
    if type(levelingFunc) == "function" then
        levelingFunc(PagePets, State, ZyloLib, Main)
    end
end)
...
print("[ZyloHub v3.5 - Modular] Loaded Successfully!")
